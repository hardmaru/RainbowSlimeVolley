...
Using Rainbow implementation in [Chainer RL](https://github.com/chainer/chainerrl) for [Slime Volleyball Environment](https://github.com/hardmaru/slimevolleygym) (Pixel Observation)
...
This is a fork of the example in [Chainer RL](https://github.com/chainer/chainerrl/tree/master/examples/atari/reproduction/rainbow). Below is from the original README:
